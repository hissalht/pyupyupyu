...
Notre jeu est codé sous Python 3 et nous utilisons pysdl2 qui est une librairie de Python pour gérer tout ce qui concerne le multimédia pour notre jeu, à savoir l'ambiance sonore et les graphismes.

Nous avons également des fichiers à part, sous l'extension .dcbbf qui sont les fichiers de blocks du jeu. 
